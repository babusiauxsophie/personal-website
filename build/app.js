(() => {
  ...
  var loader_default = initLoadingScreenEffect;
  ...
  var pin_top_default = initPinTop;

  // src/scripts/flashlight.js
  ...
  var flashlight_default = mouse;

  // src/scripts/pin-header.js
  gsapWithCSS.registerPlugin(ScrollTrigger2);
  var initPinHeader = () => {
  ...
  var pin_header_default = initPinHeader;

  // src/scripts/title-hover.js
  gsapWithCSS.registerPlugin(ScrollTrigger2);
  var initScrollHighlight = () => {
    const sections = [
  ...
  var title_hover_default = initScrollHighlight;
